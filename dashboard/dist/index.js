(function () {
  ...
  function AchievementCard({ achievement }) {
    ...
    const tierLabel = achievement.tier || (state === "discovered" ? "Progress" : state);
    return React.createElement(C.Card, { className: cn("ha-card", "ha-state-" + state, tierClass(achievement.tier)) },
    ...
    return React.createElement("div", { className: "ha-page" },
      React.createElement("section", { className: "ha-hero" },
        React.createElement("div", null,
          ...
          React.createElement("p", null, "Tiered crest badges for vibe coding, autonomous tool chains, debugging chaos, and Hermes-native workflows.")
        ),
